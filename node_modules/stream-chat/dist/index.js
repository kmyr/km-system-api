...
var ChannelState = /*#__PURE__*/function () {
  ...
  function ChannelState(channel) {
    ...
    this.typing = Immutable__default['default']({});
    this.read = Immutable__default['default']({});
    this.messages = Immutable__default['default']([]);
    this.pinnedMessages = Immutable__default['default']([]);
    this.threads = Immutable__default['default']({}); // a list of users to hide messages from

    this.mutedUsers = Immutable__default['default']([]);
    this.watchers = Immutable__default['default']({});
    this.members = Immutable__default['default']({});
    this.membership = Immutable__default['default']({});
    this.unreadCount = 0;
    /**
     * Flag which indicates if channel state contain latest/recent messages or no.
     * This flag should be managed by UI sdks using a setter - setIsUpToDate.
  ...
  _createClass__default['default'](ChannelState, [{
    ...
    value: function messageToImmutable(message) {
      return Immutable__default['default'](_objectSpread(_objectSpread({}, message), {}, {
        __html: message.html,
        // parse the date..
    ...
    value: function addMessagesSorted(newMessages) {
      ...
      for (var i = 0; i < newMessages.length; i += 1) {
        ...
        if (parentID) {
          var thread = this.threads[parentID] || Immutable__default['default']([]);
    ...
    value: function _addToMessageList(messages, message) {
      ...
      return Immutable__default['default'](mutable);
    }
    /**
...
var Channel = /*#__PURE__*/function () {
  ...
  _createClass__default['default'](Channel, [{
    ...
    key: "sendMessage",
    value: function () {
      var _sendMessage = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee2(message) {
    ...
    key: "sendReaction",
    value: function () {
      var _sendReaction = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee6(messageID, reaction, user_id, enforce_unique) {
        var body;
      ...
      switch (event.type) {
        case 'typing.start':
          if ((_event$user = event.user) !== null && _event$user !== void 0 && _event$user.id) {
            s.typing = s.typing.set(event.user.id, Immutable__default['default'](event));
          }
        ...
        case 'message.read':
          if ((_event$user3 = event.user) !== null && _event$user3 !== void 0 && _event$user3.id) {
            ...
            s.read = s.read.set(event.user.id, Immutable__default['default']({
        ...
        case 'user.updated':
          if ((_event$user5 = event.user) !== null && _event$user5 !== void 0 && _event$user5.id) {
            s.watchers = s.watchers.set(event.user.id, Immutable__default['default'](event.user));
          }
        ...
        case 'member.updated':
          if ((_event$member = event.member) !== null && _event$member !== void 0 && _event$member.user_id) {
            ...
            s.members = s.members.set((_event$member2 = event.member) === null || _event$member2 === void 0 ? void 0 : _event$member2.user_id, Immutable__default['default'](event.member));
          }
        ...
        case 'channel.updated':
          if (event.channel) {
            channel.data = Immutable__default['default'](event.channel);
          }
    ...
    value: function _initializeState(state) {
      ...
      this.state.membership = Immutable__default['default'](state.membership ? state.membership : {}); // TODO: CHECK WATCHERS TYPE!!!!!!
      // if (state.watchers) {
      ...
      if (!this.state.messages) {
        this.state.messages = Immutable__default['default']([]);
      }

      this.state.addMessagesSorted(messages, false, true);

      if (!this.state.pinnedMessages) {
        this.state.pinnedMessages = Immutable__default['default']([]);
      }
      ...
      if (state.read) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            var parsedRead = _extends__default['default'](_objectSpread$2({}, read));
...
var ClientState = /*#__PURE__*/function () {
  function ClientState() {
    ...
    this.users = Immutable__default['default']({}); // store which channels contain references to the specified user...
  ...
  _createClass__default['default'](ClientState, [{
    ...
    value: function updateUser(user) {
      if (user != null) {
        this.users = this.users.set(user.id, Immutable__default['default'](user));
      }
    }
  }, {
...
var StreamChat = /*#__PURE__*/function () {
  function StreamChat(_key, secretOrOptions, _options) {
    ...
    _defineProperty__default['default'](this, "connectionEstablishedCount", void 0);
    ...
    _defineProperty__default['default'](this, "_setupConnection", function () {
    ...
    _defineProperty__default['default'](this, "setUser", function (user, userTokenOrProvider) {
    ...
    _defineProperty__default['default'](this, "setAnonymousUser", function () {
      return _this.connectAnonymousUser();
    });

    _defineProperty__default['default'](this, "doAxiosRequest", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee(type, url, data) {
        var options,
            requestConfig,
            response,
            _args = arguments;
    ...
    _defineProperty__default['default'](this, "recoverState", /*#__PURE__*/_asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee2() {
  ...
  _createClass__default['default'](StreamChat, [{
    ...
    */
    ...
    value: function () {
      var _updateAppSettings = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee3(options) {
    ...
    key: "getAppSettings",
    value: function () {
      var _getAppSettings = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee4() {
        return _regeneratorRuntime__default['default'].wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
    ...
    */
    ...
    value: function () {
      var _testPushSettings = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee5(userID) {
        var data,
            _args5 = arguments;
        return _regeneratorRuntime__default['default'].wrap(function _callee5$(_context5) {
          while (1) {
    ...
    key: "testSQSSettings",
    value: function () {
      var _testSQSSettings = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee6() {
        var data,
            _args6 = arguments;
        return _regeneratorRuntime__default['default'].wrap(function _callee6$(_context6) {
          while (1) {
     ...
     */
    value: function () {
      var _setGuestUser = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee7(user) {
    ...
    */
    ...
    key: "connect",
    value: function () {
      var _connect = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee8() {
    ...
    key: "queryUsers",
    value: function () {
      var _queryUsers = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee9(filterConditions) {
        var sort,
            options,
            defaultOptions,
            data,
    ...
    key: "queryChannels",
    value: function () {
      var _queryChannels = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee10(filterConditions) {
        var sort,
            options,
            defaultOptions,
            payload,
    ...
    key: "search",
    value: function () {
      var _search = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee11(filterConditions, query) {
        var options,
            payload,
            _args11 = arguments;
        return _regeneratorRuntime__default['default'].wrap(function _callee11$(_context11) {
    ...
    key: "addDevice",
    value: function () {
      var _addDevice = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee12(id, push_provider, userID) {
        return _regeneratorRuntime__default['default'].wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
    ...
    key: "getDevices",
    value: function () {
      var _getDevices = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee13(userID) {
        return _regeneratorRuntime__default['default'].wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
    ...
    key: "removeDevice",
    value: function () {
      var _removeDevice = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee14(id, userID) {
        return _regeneratorRuntime__default['default'].wrap(function _callee14$(_context14) {
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
     ...
     */
    value: function () {
      var _updateUser = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee15(userObject) {
        return _regeneratorRuntime__default['default'].wrap(function _callee15$(_context15) {
          while (1) {
            switch (_context15.prev = _context15.next) {
              case 0:
    ...
    value: function () {
      var _partialUpdateUser = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee16(partialUserObject) {
        return _regeneratorRuntime__default['default'].wrap(function _callee16$(_context16) {
          while (1) {
            switch (_context16.prev = _context16.next) {
              case 0:
    ...
    key: "upsertUsers",
    value: function () {
      var _upsertUsers = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee17(users) {
    ...
    value: function () {
      var _partialUpdateUsers = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee18(users) {
    ...
    key: "deleteUser",
    value: function () {
      var _deleteUser = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee19(userID, params) {
        return _regeneratorRuntime__default['default'].wrap(function _callee19$(_context19) {
          while (1) {
            switch (_context19.prev = _context19.next) {
              case 0:
    ...
    key: "reactivateUser",
    value: function () {
      var _reactivateUser = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee20(userID, options) {
        return _regeneratorRuntime__default['default'].wrap(function _callee20$(_context20) {
          while (1) {
            switch (_context20.prev = _context20.next) {
              case 0:
    ...
    key: "deactivateUser",
    value: function () {
      var _deactivateUser = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee21(userID, options) {
        return _regeneratorRuntime__default['default'].wrap(function _callee21$(_context21) {
          while (1) {
            switch (_context21.prev = _context21.next) {
              case 0:
    ...
    key: "exportUser",
    value: function () {
      var _exportUser = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee22(userID, options) {
        return _regeneratorRuntime__default['default'].wrap(function _callee22$(_context22) {
          while (1) {
            switch (_context22.prev = _context22.next) {
              case 0:
    ...
    key: "banUser",
    value: function () {
      var _banUser = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee23(targetUserID, options) {
        return _regeneratorRuntime__default['default'].wrap(function _callee23$(_context23) {
          while (1) {
            switch (_context23.prev = _context23.next) {
              case 0:
    ...
    key: "unbanUser",
    value: function () {
      var _unbanUser = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee24(targetUserID, options) {
        return _regeneratorRuntime__default['default'].wrap(function _callee24$(_context24) {
          while (1) {
            switch (_context24.prev = _context24.next) {
              case 0:
    ...
    key: "shadowBan",
    value: function () {
      var _shadowBan = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee25(targetUserID, options) {
        return _regeneratorRuntime__default['default'].wrap(function _callee25$(_context25) {
          while (1) {
            switch (_context25.prev = _context25.next) {
              case 0:
    ...
    key: "removeShadowBan",
    value: function () {
      var _removeShadowBan = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee26(targetUserID, options) {
        return _regeneratorRuntime__default['default'].wrap(function _callee26$(_context26) {
          while (1) {
            switch (_context26.prev = _context26.next) {
              case 0:
    ...
    key: "muteUser",
    value: function () {
      var _muteUser = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee27(targetID, userID) {
        var options,
            _args27 = arguments;
        return _regeneratorRuntime__default['default'].wrap(function _callee27$(_context27) {
          while (1) {
    ...
    key: "unmuteUser",
    value: function () {
      var _unmuteUser = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee28(targetID, currentUserID) {
        return _regeneratorRuntime__default['default'].wrap(function _callee28$(_context28) {
          while (1) {
            switch (_context28.prev = _context28.next) {
              case 0:
    ...
    key: "flagMessage",
    value: function () {
      var _flagMessage = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee29(targetMessageID) {
        var options,
            _args29 = arguments;
        return _regeneratorRuntime__default['default'].wrap(function _callee29$(_context29) {
          while (1) {
    ...
    key: "flagUser",
    value: function () {
      var _flagUser = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee30(targetID) {
        var options,
            _args30 = arguments;
        return _regeneratorRuntime__default['default'].wrap(function _callee30$(_context30) {
          while (1) {
    ...
    key: "unflagMessage",
    value: function () {
      var _unflagMessage = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee31(targetMessageID) {
        var options,
            _args31 = arguments;
        return _regeneratorRuntime__default['default'].wrap(function _callee31$(_context31) {
          while (1) {
    ...
    key: "unflagUser",
    value: function () {
      var _unflagUser = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee32(targetID) {
        var options,
            _args32 = arguments;
        return _regeneratorRuntime__default['default'].wrap(function _callee32$(_context32) {
          while (1) {
    ...
    key: "markAllRead",
    value: function () {
      var _markAllRead = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee33() {
        var data,
            _args33 = arguments;
        return _regeneratorRuntime__default['default'].wrap(function _callee33$(_context33) {
          while (1) {
    ...
    value: function () {
      var _translateMessage = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee34(messageId, language) {
        return _regeneratorRuntime__default['default'].wrap(function _callee34$(_context34) {
          while (1) {
            switch (_context34.prev = _context34.next) {
              case 0:
    ...
    key: "updateMessage",
    value: function () {
      var _updateMessage = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee35(message, userId) {
    ...
    key: "deleteMessage",
    value: function () {
      var _deleteMessage = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee36(messageID, hardDelete) {
        var params;
    ...
    key: "getMessage",
    value: function () {
      var _getMessage = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee37(messageID) {
