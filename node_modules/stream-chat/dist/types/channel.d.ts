...
import { APIResponse, BanUserOptions, ChannelAPIResponse, ChannelData, ChannelMemberAPIResponse, ChannelQueryOptions, ChannelResponse, DeleteChannelAPIResponse, Event, EventAPIResponse, EventHandler, EventTypes, GetMultipleMessagesAPIResponse, GetReactionsAPIResponse, GetRepliesAPIResponse, InviteOptions, LiteralStringForUnion, MarkReadOptions, Message, MessageFilters, MuteChannelAPIResponse, PaginationOptions, PartialUpdateChannel, PartialUpdateChannelAPIResponse, Reaction, ReactionAPIResponse, SearchAPIResponse, SendMessageAPIResponse, TruncateChannelAPIResponse, UnknownType, UpdateChannelAPIResponse, UserFilters, UserResponse, UserSort } from './types';
/**
...
export declare class Channel<AttachmentType extends UnknownType = UnknownType, ChannelType extends UnknownType = UnknownType, CommandType extends string = LiteralStringForUnion, EventType extends UnknownType = UnknownType, MessageType extends UnknownType = UnknownType, ReactionType extends UnknownType = UnknownType, UserType extends UnknownType = UnknownType> {
    ...
    type: string;
    id: string | undefined;
    data: ChannelData<ChannelType> | ChannelResponse<ChannelType, CommandType, UserType> | Immutable.Immutable<ChannelResponse<ChannelType, CommandType, UserType>> | undefined;
     ...
     */
    sendMessage(message: Message<AttachmentType, MessageType, UserType>): Promise<SendMessageAPIResponse<AttachmentType, ChannelType, CommandType, MessageType, ReactionType, UserType>>;
     ...
     */
    search(query: MessageFilters<AttachmentType, ChannelType, CommandType, MessageType, ReactionType, UserType> | string, options?: {
        client_id?: string;
     ...
     */
    sendReaction(messageID: string, reaction: Reaction<ReactionType, UserType>, user_id?: string, enforce_unique?: boolean): Promise<ReactionAPIResponse<AttachmentType, ChannelType, CommandType, MessageType, ReactionType, UserType>>;
    /**
     ...
     */
    update(channelData?: Partial<ChannelData<ChannelType>> | Partial<ChannelResponse<ChannelType, CommandType, UserType>> | Partial<Immutable.Immutable<ChannelResponse<ChannelType, CommandType, UserType>>>, updateMessage?: Message<AttachmentType, MessageType, UserType>): Promise<UpdateChannelAPIResponse<AttachmentType, ChannelType, CommandType, MessageType, ReactionType, UserType>>;
    /**
     ...
     * @return {Promise<UpdateChannelAPIResponse<AttachmentType, ChannelType, CommandType, MessageType, ReactionType, UserType>>} The server response
     */
    addMembers(members: string[], message?: Message<AttachmentType, MessageType, UserType>): Promise<UpdateChannelAPIResponse<AttachmentType, ChannelType, CommandType, MessageType, ReactionType, UserType>>;
    /**
     ...
     * @return {Promise<UpdateChannelAPIResponse<AttachmentType, ChannelType, CommandType, MessageType, ReactionType, UserType>>} The server response
     */
    inviteMembers(members: string[], message?: Message<AttachmentType, MessageType, UserType>): Promise<UpdateChannelAPIResponse<AttachmentType, ChannelType, CommandType, MessageType, ReactionType, UserType>>;
    /**
    ...
    lastMessage(): Immutable.Immutable<Immutable.Immutable<MessageType & {
        ...
        channel?: ChannelResponse<ChannelType, CommandType, UserType> | undefined;
        ...
        latest_reactions?: import("./types").ReactionResponse<ReactionType, UserType>[] | undefined;
        mentioned_users?: UserResponse<UserType>[] | undefined;
        own_reactions?: import("./types").ReactionResponse<ReactionType, UserType>[] | null | undefined;
        pin_expires?: string | null | undefined;
        pinned_by?: UserResponse<UserType> | null | undefined;
        quoted_message?: Pick<import("./types").MessageResponse<AttachmentType, ChannelType, CommandType, MessageType, ReactionType, UserType>, "user" | "silent" | "html" | "text" | "created_at" | "updated_at" | "status" | "id" | "attachments" | "mml" | "parent_id" | "pinned" | "quoted_message_id" | "show_in_channel" | "user_id" | "args" | "channel" | "cid" | "command" | "command_info" | "deleted_at" | "latest_reactions" | "mentioned_users" | "own_reactions" | "pin_expires" | "pinned_at" | "pinned_by" | "reaction_counts" | "reaction_scores" | "reply_count" | "shadowed" | "thread_participants" | "type" | Exclude<keyof MessageType, "quoted_message">> | undefined;
        reaction_counts?: {
            [key: string]: number;
        } | null | undefined;
        reaction_scores?: {
     ...
     */
    on(eventType: EventTypes, callback: EventHandler<AttachmentType, ChannelType, CommandType, EventType, MessageType, ReactionType, UserType>): void;
    on(callback: EventHandler<AttachmentType, ChannelType, CommandType, EventType, MessageType, ReactionType, UserType>): void;
    /**
