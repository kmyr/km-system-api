...
export declare type ImmutableMessageResponse<AttachmentType = UnknownType, ChannelType = UnknownType, CommandType extends string = LiteralStringForUnion, MessageType = UnknownType, ReactionType = UnknownType, UserType = UnknownType> = SeamlessImmutable.Immutable<Omit<MessageResponse<AttachmentType, ChannelType, CommandType, MessageType, ReactionType, UserType>, 'created_at' | 'updated_at' | 'status'> & {
    __html: string;
    created_at: Date;
    status: string;
    updated_at: Date;
...
export declare type QuerySort<ChannelType = UnknownType, UserType = UnknownType> = ChannelSort<ChannelType> | UserSort<UserType>;
/**
 * Base Types
 */
