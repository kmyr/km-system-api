...
export declare class ChannelState<AttachmentType extends UnknownType = UnknownType, ChannelType extends UnknownType = UnknownType, CommandType extends string = LiteralStringForUnion, EventType extends UnknownType = UnknownType, MessageType extends UnknownType = UnknownType, ReactionType extends UnknownType = UnknownType, UserType extends UnknownType = UnknownType> {
    ...
    pinnedMessages: Immutable.ImmutableArray<ReturnType<ChannelState<AttachmentType, ChannelType, CommandType, EventType, MessageType, ReactionType, UserType>['messageToImmutable']>>;
    ...
    addReaction(reaction: ReactionResponse<ReactionType, UserType>, message?: MessageResponse<AttachmentType, ChannelType, CommandType, MessageType, ReactionType, UserType>, enforce_unique?: boolean): void;
    _addReactionToMessage(message: Immutable.Immutable<ReturnType<ChannelState<AttachmentType, ChannelType, CommandType, EventType, MessageType, ReactionType, UserType>['messageToImmutable']>>, reaction: ReactionResponse<ReactionType, UserType>, enforce_unique?: boolean): false | Immutable.ImmutableObject<Record<string, unknown> & {
        id: string;
        attachments?: import("./types").Attachment<AttachmentType>[] | undefined;
        html?: string | undefined;
        mml?: string | undefined;
    ...
    _removeReactionFromMessage(message: Immutable.Immutable<ReturnType<ChannelState<AttachmentType, ChannelType, CommandType, EventType, MessageType, ReactionType, UserType>['messageToImmutable']>>, reaction: ReactionResponse<ReactionType, UserType>, enforce_unique?: boolean): Immutable.ImmutableObject<Record<string, unknown> & {
        id: string;
        attachments?: import("./types").Attachment<AttachmentType>[] | undefined;
        html?: string | undefined;
        mml?: string | undefined;
